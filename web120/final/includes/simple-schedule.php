...
#EDIT THE FOLLOWING:
$toAddress = "filmfanadam@gmail.com";  //place your/your client's email address here
$toName = "Adam Nelson"; //place your client's name here
$website = "Alevam.com";  //place NAME of your client's website here
#--------------END CONFIG AREA ------------------------#
...
?>
    ...
    <div>
        <label>
			Phone:<br /><input type="tel" name="Phone" required="required" placeholder="Phone (required)" title="A valid email is required" tabindex="30" size="44" />
		</label>
    </div>
	...
	<div>	
		<label>
			Comments:<br /><textarea name="Comments" cols="36" rows="4" placeholder="Your comments are important to us!" tabindex="40"></textarea>
		</label>
	</div>	
	<div><?=$feedback?></div>
